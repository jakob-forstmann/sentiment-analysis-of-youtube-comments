...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t = text(/*name*/ ctx[0]);
    			add_location(h1, file$6, 5, 20, 83);
    			attr_dev(div, "class", "logo");
    			add_location(div, file$6, 5, 2, 65);
    			attr_dev(navbar, "class", "navbar svelte-1u6yw98");
    			add_location(navbar, file$6, 4, 0, 39);
    		},
    ...
    const fetchAllCommentsFromVideo = (videoId) => API.get(`fetch_all_comments/${videoId}`);
    ...
    const allVideoComments = writable([]);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*searchVideo*/ ctx[1], false, false, false)
    				];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	async function searchVideo(event) {
    		...
    		const { data: { videoComments, message }, status } = await fetchAllCommentsFromVideo(videoId);
    		console.log(message);
    	...
    	return [searchUrl, searchVideo, input_input_handler];
    }
    ...
    // (15:6) {#each comments as comment}
    function create_each_block$1(ctx) {
    	let li;
    	let t0_value = /*comment*/ ctx[3] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$3, 15, 8, 329);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*comments*/ 2 && t0_value !== (t0_value = /*comment*/ ctx[3] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:6) {#each comments as comment}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$3, 8, 4, 168);
    			attr_dev(h6, "class", "percentage");
    			add_location(h6, file$3, 9, 4, 201);
    			attr_dev(div0, "class", "analytics");
    			add_location(div0, file$3, 7, 2, 140);
    			attr_dev(ol, "class", "svelte-1oyyqmb");
    			add_location(ol, file$3, 13, 4, 282);
    			attr_dev(div1, "class", "comments svelte-1oyyqmb");
    			add_location(div1, file$3, 12, 2, 255);
    			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*comments*/ ctx[1].length <= 0 ? "hidden" : "") + " svelte-1oyyqmb"));
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*head*/ 1) set_data_dev(t0, /*head*/ ctx[0]);
    			if (dirty & /*percentage*/ 4) set_data_dev(t2, /*percentage*/ ctx[2]);
    			...
    			if (dirty & /*comments*/ 2 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*comments*/ ctx[1].length <= 0 ? "hidden" : "") + " svelte-1oyyqmb"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (head === undefined && !('head' in $$props || $$self.$$.bound[$$self.$$.props['head']])) {
    			console.warn("<CommentsCard> was created without expected prop 'head'");
    		}

    		if (comments === undefined && !('comments' in $$props || $$self.$$.bound[$$self.$$.props['comments']])) {
    			console.warn("<CommentsCard> was created without expected prop 'comments'");
    		}

    		if (percentage === undefined && !('percentage' in $$props || $$self.$$.bound[$$self.$$.props['percentage']])) {
    			console.warn("<CommentsCard> was created without expected prop 'percentage'");
    		}
    	});

    	const writable_props = ['head', 'comments', 'percentage'];
    	...
    	$$self.$capture_state = () => ({ head, comments, percentage });
    	...
    	return [head, comments, percentage];
    }

    class CommentsCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { head: 0, comments: 1, percentage: 2 });
    	...
    	get head() {
    		throw new Error("<CommentsCard>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set head(value) {
    		throw new Error("<CommentsCard>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    // (41:2) {#each classifiedCommentsDetails as commentDetail}
    function create_each_block(ctx) {
    	let commentscard;
    	let current;

    	commentscard = new CommentsCard({
    			props: {
    				head: /*commentDetail*/ ctx[3].head,
    				comments: /*commentDetail*/ ctx[3].comments,
    				percentage: /*commentDetail*/ ctx[3].percentage
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(commentscard.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(commentscard, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const commentscard_changes = {};
    			if (dirty & /*classifiedCommentsDetails*/ 1) commentscard_changes.head = /*commentDetail*/ ctx[3].head;
    			if (dirty & /*classifiedCommentsDetails*/ 1) commentscard_changes.comments = /*commentDetail*/ ctx[3].comments;
    			if (dirty & /*classifiedCommentsDetails*/ 1) commentscard_changes.percentage = /*commentDetail*/ ctx[3].percentage;
    			commentscard.$set(commentscard_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(commentscard.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(commentscard.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(commentscard, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:2) {#each classifiedCommentsDetails as commentDetail}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let div;
    	let current;
    	let each_value = /*classifiedCommentsDetails*/ ctx[0];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 39, 0, 1239);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*classifiedCommentsDetails*/ 1) {
    				each_value = /*classifiedCommentsDetails*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const unSubscribeAllVideoComments = allVideoComments.subscribe(comments => {
    		...
    		const negative = comments.negative,
    			positive = comments.positive,
    			neutral = comments.neutral;

    		const noOfNegative = comments.negative.length,
    			noOfPositive = comments.positive.length,
    			noOfNeutral = comments.neutral.length;

    		const total = noOfNegative + noOfPositive + noOfNeutral;

    		$$invalidate(0, classifiedCommentsDetails = [
    			{
    				head: "Negative",
    	...
    	$$self.$capture_state = () => ({
    		...
    		calculatePercentage,
    		unSubscribeAllVideoComments
    	});

    	$$self.$inject_state = $$props => {
    		if ('classifiedCommentsDetails' in $$props) $$invalidate(0, classifiedCommentsDetails = $$props.classifiedCommentsDetails);
    	};
    	...
    	return [classifiedCommentsDetails];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 3, 2, 30);
    			attr_dev(footer, "class", "svelte-2f2kbk");
    			add_location(footer, file$1, 2, 0, 19);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 9, 0, 335);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) navbar_changes.name = /*name*/ ctx[0];
