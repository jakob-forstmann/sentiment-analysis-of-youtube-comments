...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t = text(/*name*/ ctx[0]);
    			add_location(h1, file$6, 5, 20, 88);
    			attr_dev(div, "class", "logo");
    			add_location(div, file$6, 5, 2, 70);
    			attr_dev(navbar, "class", "navbar svelte-1u6yw98");
    			add_location(navbar, file$6, 4, 0, 43);
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$3, 15, 8, 344);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$3, 8, 4, 176);
    			attr_dev(h6, "class", "percentage");
    			add_location(h6, file$3, 9, 4, 210);
    			attr_dev(div0, "class", "analytics");
    			add_location(div0, file$3, 7, 2, 147);
    			attr_dev(ol, "class", "svelte-1oyyqmb");
    			add_location(ol, file$3, 13, 4, 295);
    			attr_dev(div1, "class", "comments svelte-1oyyqmb");
    			add_location(div1, file$3, 12, 2, 267);
    ...
    // (42:2) {#each commentsClasses as commentsClass}
    function create_each_block(ctx) {
    	...
    	commentscard = new CommentsCard({
    			props: {
    				head: /*commentsClass*/ ctx[3].head,
    				comments: /*commentsClass*/ ctx[3].comments,
    				percentage: /*commentsClass*/ ctx[3].percentage
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*commentsClasses*/ 1) commentscard_changes.head = /*commentsClass*/ ctx[3].head;
    			if (dirty & /*commentsClasses*/ 1) commentscard_changes.comments = /*commentsClass*/ ctx[3].comments;
    			if (dirty & /*commentsClasses*/ 1) commentscard_changes.percentage = /*commentsClass*/ ctx[3].percentage;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:2) {#each commentsClasses as commentsClass}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let div;
    	let current;
    	let each_value = /*commentsClasses*/ ctx[0];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 40, 0, 1158);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*commentsClasses*/ 1) {
    				each_value = /*commentsClasses*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<VideoComments> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('videoComments' in $$props) videoComments = $$props.videoComments;
    		if ('commentsClasses' in $$props) $$invalidate(0, commentsClasses = $$props.commentsClasses);
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 9, 0, 344);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
